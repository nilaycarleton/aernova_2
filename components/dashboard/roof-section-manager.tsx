      ...
      <div className="mt-6 space-y-4">
        {sections.length === 0 ? (
          ...
          sections.map((section) => (
            <div key={section.id} className="rounded-2xl border border-white/10 bg-slate-950/45 p-4">
              <form action={updateRoofSectionAction} className="grid gap-3 md:grid-cols-4 xl:grid-cols-9">
                ...
                <input
                  ...
                  className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-white outline-none focus:border-blue-400 md:col-span-2"
                  required
                />
                <input
                  name="pitchRatio"
