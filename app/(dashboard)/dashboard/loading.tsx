  ...
  return (
    <div className="min-w-0 space-y-8" aria-busy="true">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-hairline bg-surface-raised p-6 lg:col-span-2">
          <div className="h-4 w-32 animate-pulse rounded-md bg-surface-lifted" />
          <div className="mt-3">
            <SkeletonList rows={4} />
          </div>
        </div>
        <div className="rounded-2xl border border-hairline bg-surface-raised p-6">
          <SkeletonReadout />
        </div>
      </div>
