...
/** Store one before/after photo and record it as BEFORE/AFTER project imagery
...
export async function POST(
  ...
  try {
    beforeUrl = await uploadComparisonPhoto(projectId, formData.get("beforeImage"), "BEFORE");
    afterUrl = await uploadComparisonPhoto(projectId, formData.get("afterImage"), "AFTER");
  } catch (error) {
