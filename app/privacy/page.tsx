        ...
        <article className="rounded-lg border border-paper-rule bg-paper-document p-6 sm:p-10">
          ...
          <ul className="mt-3 max-w-prose list-disc space-y-2 pl-5 leading-7 text-paper-ink-body">
            ...
            <li>
              ...
              or quote draft) using Google&rsquo;s Gemini API. Every AI-drafted result is shown to
              the Contractor for review before it is saved or sent — nothing generated by AI
              reaches a Client without a person reading it first.
            </li>
          ...
          <ul className="mt-3 max-w-prose list-disc space-y-2 pl-5 leading-7 text-paper-ink-body">
            ...
            <li>
              <strong>Google</strong> (Gemini API) — AI-assisted drafting features, when a
              Contractor uses them.
            </li>
            <li>
