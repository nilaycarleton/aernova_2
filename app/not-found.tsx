...
export default function NotFound() {
  return (
    <main id="main-content" tabIndex={-1} className="flex min-h-screen items-center justify-center bg-ground p-6 text-ink-primary outline-none">
      <div className="max-w-md rounded-lg border border-hairline bg-surface-raised p-8 text-center">
        ...
        <Link
          href="/dashboard"
          className="mt-6 inline-block rounded-lg border border-hairline bg-info/20 px-4 py-2 text-sm font-medium text-info-fg transition hover:bg-info/30"
        >
          Back to dashboard
        </Link>
      </div>
